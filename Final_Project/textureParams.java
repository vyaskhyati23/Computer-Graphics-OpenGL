...
public class textureParams {
	...
	public void loadTexture(GL3 gl3) {
		...
		try {
			...
			InputStream file = new BufferedInputStream(new FileInputStream("sun1.jpg"));
			// CREATES A TEXTURE DATA.
			TextureData data = TextureIO.newTextureData(gl3.getGLProfile(), file, false, "jpg");
			texture_front = TextureIO.newTexture(data);

			// READING THE FILE THAT NEEDS TO BE MAPPED ON THE QUAD BACK.
			file = new BufferedInputStream(new FileInputStream("map.jpg"));
			// CREATES A TEXTURE DATA.
			data = TextureIO.newTextureData(gl3.getGLProfile(), file, false, "jpg");
